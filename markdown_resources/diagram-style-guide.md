...
2. **Open the proof file** (`../proof_html_resources/fastq-anatomy-proof.html`) to copy the marker/typography/color patterns.
...
The file `../proof_html_resources/fastq-anatomy-proof.html` is the reference implementation of this style. When in doubt about arrow style, typography, kicker labels, callout boxes, or monospace integration, **copy patterns from that file directly**. It is the ground truth.
